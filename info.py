...
# Bot Admins
ADMINS = environ.get('ADMINS', '1413071149')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001956051232 -1001898364516 -1001825733498').split()]
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001557431626').split()]
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/z_harbour')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/mdisk_bots')
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/mdisk_bots")
